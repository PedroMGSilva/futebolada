...
export async function findGuestByName(input: FindByNameInput): Promise<Guest | null> {
  const result = await pool.query<Guest>(
...
export async function createGuestAndPlayer(input: CreateGuestInput): Promise<Guest> {
